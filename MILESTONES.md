...
Agent chains multiple tool calls to answer complex questions. "Compare my workout frequency this month vs last and tell me if my resting HR improved" — requires SQL + memory + reasoning across results.
